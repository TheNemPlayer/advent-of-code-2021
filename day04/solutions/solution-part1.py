with open("day04/inputs/input-part1.in") as input_file:
...
combination_list = []
for board in boards:
    combination_list.append(board_combinations(board))

for index, number in enumerate(numbers_drawn):
    combination *= prime[number]

    for board_index, combination_set in enumerate(combination_list):
